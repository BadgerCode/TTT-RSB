-- Config
CreateConVar("RSB_ChargeTimer", "5", FCVAR_SERVER_CAN_EXECUTE, "This is the charge timer for the RSB(number, def: 15)")
...
CreateConVar("RSB_EnableCam", "false", FCVAR_SERVER_CAN_EXECUTE, "Enable the display of your targets camera when fully charged (true/false, def: true)")