		...
		if tr.HitNonWorld then
			...
			if target:IsPlayer() then 
				if IsValid(target) and IsValid(target.attachedRSB) then							
					ply:PrintMessage(HUD_PRINTCENTER, "You've successfully defused an RSB")
					target.attachedRSB.Owner:PrintMessage(HUD_PRINTCENTER, "Your RSB was defused!")
					...
					ply:PrintMessage(HUD_PRINTCENTER, "This player has no RSB attached to them!")
				end				
			end
		end
	end
